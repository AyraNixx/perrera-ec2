...
CREATE TABLE IF NOT EXISTS `perrera`.`animales` (
  ...
  CONSTRAINT `fk_animales_especies1`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_animales_dueños1`  
    FOREIGN KEY (`dueños_id`)
...
CREATE TABLE IF NOT EXISTS `perrera`.`duenios` (
  ...
  `telf` VARCHAR(15) NOT NULL DEFAULT 'No especificado',
  `direccion` VARCHAR(255) NOT NULL DEFAULT 'No especificado',
  `ciudad` VARCHAR(100) NOT NULL DEFAULT 'No especificado',
  `codigo_postal` VARCHAR(10) NOT NULL DEFAULT 'No especificado',
  `pais` VARCHAR(50) NOT NULL DEFAULT 'No especificado',
