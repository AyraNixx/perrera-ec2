...
class AtencionVeterinariaC
{
    ...
    private function pagination()
    {
        ...
        foreach ($data as $show_data) {
            ...
            $html_var .= '<a href="../controllers/AtencionVeterinariaC.php?action=show_register&id=' . $show_data['id'] . '" class="btn btn-primary text-white btn-sm me-1">Ver</a>';
            $html_var .= '<a href="../controllers/AtencionVeterinariaC.php?action=sdelete&id=' . $show_data['id'] . '" class="btn btn-danger text-white btn-sm me-1">Borrar</a>';            
            $html_var .= "</td>";
            $html_var .= "</tr>";
        }
