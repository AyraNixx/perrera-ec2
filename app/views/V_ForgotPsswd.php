            ...
            <div class="row justify-content-center align-items-center col-10 col-sm-7 col-md-6 col-lg-3 p-2">
                <form class="login" method="POST" action="../app/controllers/LoginC.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control bg-transparent" placeholder = "************" name="new_passwd" id="new_passwd" required>
                    </div>
                    <div class="form-group mt-4">
                        <label for="new_passwd2">Confirmar contraseña</label>
                        <input type="password" class="form-control bg-transparent" placeholder = "************" name="new_passwd2" id="new_passwd2" required>
                    </div>
                    <div class="form-group text-center mt-4">
                        <button type="submit" class="btn btn-primary mt-3 py-2 px-5" name="action" value="change_passwd">Guardar</button>
                    </div>
                </form>
