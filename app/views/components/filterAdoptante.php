            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-10 col-md-9 col-sm-11">
                    <div class="d-flex flex-column"><span class="title_name" style=" font-size: .7rem;"></span>
                        <h6 class="h5 text-primary mb-0" style="letter-spacing: 0; text-transform:none !important; font-size:.8rem;" data-controller='AdoptanteC.php'>Listado de filtros para <span class="title_name"></span></h6>
                    </div>
                </div>
