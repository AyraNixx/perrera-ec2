            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-10 col-md-9 col-sm-11">
                    <div class="d-flex flex-column"><span class="title_name" style=" font-size: .7rem;"></span>
                        <h6 class="h5 text-primary mb-0" style="letter-spacing: 0; text-transform:none !important; font-size:.8rem;" data-controller='AsignarTareasC.php'>Listado de filtros para <span class="title_name"></span></h6>
                    </div>
                </div>
            ...
            <div class="row my-2">
                <div class="text-primary">
                    ...
                    <select id="filter-select" class="form-control border border-0 border-bottom border-primary rounded-0 text-primary shadow-none ps-0" style="font-size: .85rem;">
                        <option value="" >Todas las tareas asignadas</option>
                    </select>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-10 col-md-12 md-sm-1 mb-1">
                    <div class="btn-group" role="group">
                        <button class="button-dropdown" id="add" data-toggle="modal" data-target="#add_tarea_asignada">Añadir</button>
                        <?php
                    ...
                    <div class="btn-group dropdown" style="position:relative">
                        <button type="button" id="add" class="button-dropdown " data-toggle="modal" data-target="#add_tarea_asignada">
                            Añadir
                        </button>
