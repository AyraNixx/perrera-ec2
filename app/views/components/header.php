<header class="w-100 navbar border-0 border-bottom border-secondary border-2 bg-white position-fixed top-0" style="z-index:99">
    ...
    <button class="h-100 border-0 bg-transparent position-relative me-3" type="button" id="header-btn">
        <div class="hamburguer-inner position-absolute start-50 top-0">
