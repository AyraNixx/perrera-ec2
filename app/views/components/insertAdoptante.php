                    ...
                    <form action="../controllers/AdoptanteC.php" method="POST" class="d-flex flex-column w-100" enctype="multipart/form-data">
                        ...
                        <div class="row border border-1 border-secondary mx-1 p-2">
                            ...
                            <div class="col-md-4 d-flex align-self-end">
                                <input type="hidden" name="tiene_jardin" value="0">
                                <label for="tiene_jardin_chk" class="d-flex align-self-center">¿Tiene Jardín?<input type="checkbox" name="tiene_jardin_chk" id="tiene_jardin_chk" class="ms-3" style="width: fit-content;" value="0"></label>
                            </div>
                            <div class="col-md-4 d-flex align-self-end mb-3">
                                <input type="hidden" name="otra_mascota" value="0">
                                <label for="otra_mascota_chk" class="d-flex align-self-center">¿Tiene mascota/s?<input type="checkbox" name="otra_mascota_chk" id="otra_mascota_chk" class="ms-3" style="width: fit-content;" value="0"></label>
                            </div>
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col-md-4">
                                <label for="fecha_adopcion">Fecha de de la adopción</label>
                                <input type="date" name="fecha_adopcion" id="fecha_adopcion" value="">
                            </div>
                            <div class="col-md-8">
                                <label for="estado_adopcion">Estado de la adopción</label>
                                <select name="estado_adopcion" id="estado_adopcion"></select>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-4 ">
                                <input type="hidden" name="preferencia_adopcion" value="0">
                                <label for="preferencia_adopcion_chk" class="d-flex align-self-center">Preferencia
                                    <input type="checkbox" name="preferencia_adopcion_chk" id="preferencia_adopcion_chk" class="ms-3" style="width: fit-content;" value="0">
                                </label>
                            </div>
                        </div>
