                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group my-4 mb-1" style="position: relative; margin-top:1.7rem !important">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-primary text-white border-0" style="border-start-end-radius: 0; border-end-end-radius: 0;">Upload</span>
                                    </div>
                                    <div class="custom-file flex-grow-1 border border-1 border-primary" style="padding: .3em; border-start-end-radius: 4px; border-end-end-radius: 4px;">
                                        <input type="file" class="custom-file-input d-none" id="img">
                                        <label class="custom-file-label" for="img" style="padding: 0;">Subir imagen...</label>
                                    </div>
                                </div>
