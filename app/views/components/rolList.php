                ...
                <div class="btn-group dropdown d-block" style="position:relative">
                    ...
                    <div class="btn-dropdown-options w-auto position-absolute start-0">
                        <ul class="list-unstyled m-0">
                            ...
                            <li>
                                <a href=<?= "../controllers/RolC.php?action=update_modal&id=" . $show_data["id"] ?>>Editar</a>
                            </li>
                            <li>
                            ...
                            ?>
                                <li>
                                    <a href=<?= "../controllers/RolC.php?action=undelete&id=" . $show_data["id"] ?>>Recuperar registro</a>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
