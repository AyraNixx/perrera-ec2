    <div class="modal fade" id="search_duenio" tabindex="-1" aria-labelledby="search_duenio" aria-hidden="true" style="z-index: 20000; background: rgba(0, 0, 0, 0.22);">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="search_duenio_val" class="form-control" placeholder="Buscar en la tabla..." aria-label="Buscar" aria-describedby="basic-addon1" style="outline: none; box-shadow: none;">
                                </div>
                            </div>
                        </div>
                    </div>
